 ...
 * @author Jun Tan
 */
@ContextConfiguration(classes = [UserServiceGetUserById2Spec.class])
//@ComponentScan("com.meituan.mtest.demo.user")
@ImportResource("classpath:spring-context.xml")
@Configuration
class UserServiceGetUserById2Spec extends Specification implements BeanFactoryPostProcessor {
